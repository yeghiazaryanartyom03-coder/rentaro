  ...
  return (
    <main className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
      ...
      <section className="grid gap-4 text-base leading-7 text-[#D4D4D4]">
        <p>
          Мы помогаем быстро подобрать автомобиль для поездок по городу, деловых
          встреч и путешествий. Акцент делаем на ухоженном автопарке, прозрачной
          цене и поддержке на каждом этапе аренды.
        </p>
